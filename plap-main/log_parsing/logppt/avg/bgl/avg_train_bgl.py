...
from avg_bgl import Dtrain
from avg_virtual_bgl import updated_model, updated_tokenizer, add_new_tokens
...
# 读取文件到 DataFrame
train_file_path = '/home/zhouzt/code/logs/BGL/BGL_2k.log_structured.csv'
