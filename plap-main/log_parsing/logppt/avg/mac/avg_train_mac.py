...
from avg_virtual_mac import updated_model, updated_tokenizer, add_new_tokens
...
# 读取文件到 DataFrame
train_file_path = '/home/zhouzt/experiment/log_parsing/logs/Mac/Mac_2k.log_structured.csv'
