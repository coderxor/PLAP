...
from random_hdfs import Dtrain
from virtual_hdfs import updated_model, updated_tokenizer, add_new_tokens
...
# 读取文件到 DataFrame
train_file_path = '/home/zhouzt/experiment/log_parising/logs/HDFS/HDFS_2k.log_structured.csv'
