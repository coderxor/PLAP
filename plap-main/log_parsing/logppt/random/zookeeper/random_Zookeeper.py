...
# 读取数据
preprocessed_logs_df = pd.read_csv('/home/zhouzt/code/logs/Zookeeper/Zookeeper_2k.log_structured.csv')
structured_logs_df = pd.read_csv('/home/zhouzt/code/logs/Zookeeper/Zookeeper_2k.log_structured.csv')
