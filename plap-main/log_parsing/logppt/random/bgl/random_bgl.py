...
# 读取数据
preprocessed_logs_df = pd.read_csv('/home/zhouzt/code/logs/BGL/BGL_2k_preprocessed.csv')
structured_logs_df = pd.read_csv('/home/zhouzt/code/logs/BGL/BGL_2k.log_structured.csv')
