...
# 读取数据
preprocessed_logs_df = pd.read_csv('/logs/Thunderbird/Android_2k.log_structured.csv')
structured_logs_df = pd.read_csv('/logs/Thunderbird/Android_2k.log_structured.csv')
